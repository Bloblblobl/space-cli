...
running command...
$ space-cli (--version)
space-cli/0.0.0 win32-x64 node-v14.17.3
...
_See code: [dist/commands/hello/index.ts](https://github.com/Bloblblobl/space-cli/blob/v0.0.0/dist/commands/hello/index.ts)_
